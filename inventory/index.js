...
inventory.MenuBulkUpdate = require("./MenuBulkUpdate");
inventory.MenuItem = require("./MenuItem");
inventory.MenuModifier = require("./MenuModifier");
inventory.MenuModifierGroup = require("./MenuModifierGroup");
inventory.MenuSection = require("./MenuSection");
