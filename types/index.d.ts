...
export namespace payments {
    ...
    export class AssociatedPayment {
        getId(): string;

        setId(id: string): void;

        getType(): payments.AssociationType;

        setType(type: payments.AssociationType): void;

        getMetaInfo(fieldName: string): object
    }


    export class AssociatedPayments {
        getAssociatedPayments(): Array<payments.AssociatedPayment>;

        setAssociatedPayments(associatedPayments: Array<payments.AssociatedPayment>): void;
...
export namespace remotemessage {
    ...
    export class AddLineItemAction {
        getDiscount(): order.DisplayLineItem;

        setDiscount(discount: order.DisplayLineItem): void;
...
export namespace remotepay {
    ...
    export class ICloverConnectorListener {
        ...
        onReady(merchantInfo: remotepay.MerchantInfo): void;
    ...
    export class PrintRequest extends BaseRequest {
        getImage(): Array<remotepay.Img>;

        setImage(image: Array<remotepay.Img>): void;
