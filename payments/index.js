...
payments.ECommTransactionInfo = require("./ECommTransactionInfo");
payments.EndpointTotalStats = require("./EndpointTotalStats");
payments.FailedBatchSettlement = require("./FailedBatchSettlement");
payments.FraudResponseAction = require("./FraudResponseAction");
payments.FraudResponseCodeType = require("./FraudResponseCodeType");
payments.FraudResponseReason = require("./FraudResponseReason");
...
payments.IncrementalAuthorization = require("./IncrementalAuthorization");
...
payments.PaymentResponseFraudSetting = require("./PaymentResponseFraudSetting");
payments.PaymentTaxRate = require("./PaymentTaxRate");
payments.PromotionalMessage = require("./PromotionalMessage");
